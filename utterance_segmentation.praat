...
##### Parameter values changed by José M. Lahoz-Bengoechea (2021-05-26): original values remain in commented lines.
include utils.praat
alpha=0.25
# silence_detection = -25
# minimal_silence_duration = 0.2
# minimal_utterance_duration = 0.1
silence_detection = -45
minimal_silence_duration = 0.3
minimal_utterance_duration = 0.8
keep_silence_tier = 0
